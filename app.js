(() => {
  ...
  function renderMetrics() {
    ...
    document.querySelector('#release-reason').textContent = `${urgent} critical/high findings remain open across the 7 scoped scenarios.`;
  }
  ...
  function activeFilterText() {
    ...
    return parts.length ? parts.join(' · ') : 'Full Cross-role platform journeys record';
  }
  ...
  function openFinding(id, updateHash = true) {
    ...
    elements.dialogContent.innerHTML = `
      ...
      <section class="detail-section">
        ...
        <p>${escapeHtml(finding.evidenceStatus)} · 12 September cross-role platform journey Chrome campaign. Private <code>tests/e2e/admin/</code> run records are the source of this sanitized consolidation. <a href="#coverage" id="dialog-coverage">View scenario coverage and provenance</a>.</p>
      ...
      <section class="detail-section">
        <h3>Lifecycle</h3>
        <div class="timeline">
          <div class="timeline-item done"><strong>Finding recorded</strong><small>${finding.scenario} · Cross-role platform journeys Chrome evidence run</small></div>
  ...
  function exportCsv() {
    ...
    link.download = 'cross-role-platform-journeys-uat-20260912.csv';
    link.click();
